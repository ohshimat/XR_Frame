#ifndef __UnityThreedVector_h__
#define __UnityThreedVector_h__
...
public:
   ...
   */
  //********************************************************************
  uoThreedVector(double val1, double val2, double val3);
   ...
   */
  //********************************************************************
  uoThreedVector(const uoThreedVector &val);
   ...
   *  @return  uoThreedVector ... ３Ｄベクトルクラスオブジェクト
   *  @date  2008/12/1 ... 新規作成
   */
  //********************************************************************
  uoThreedVector operator+(uoThreedVector &val);
   ...
   */
  //********************************************************************
  uoThreedVector operator*(double val);

  //*******************************************************************
  /*!
   *  @brief  スカラーの除算を行います。
   *  @param  val ...[In] 除算用スカラー
   *  @return  uoThreedVector ... ３Ｄベクトルクラスオブジェクト@n
   ...
   */
  //********************************************************************
  uoThreedVector &operator=(const uoThreedVector &val);
   ...
   */
  //********************************************************************
  bool operator==(uoThreedVector &val);
   ...
   */
  //********************************************************************
  double getDotProduct(uoThreedVector &val);

  //*******************************************************************
  /*!
   *  @brief  外積の取得を行います。
   *  @param  val ... [In] ３Ｄベクトルクラスオブジェクト
   *  @return  uoThreedVector ... 外積(３Ｄベクトルクラスオブジェクト)
   *  @date  2008/12/1 ... 新規作成
   */
  //********************************************************************
  uoThreedVector getCrossProduct(uoThreedVector &val);
   ...
   */
  //********************************************************************
  double getAngle(uoThreedVector &val);
