...
//IGNORE WARNING FOR MICROSOFT VISUAL STUDIO
#pragma warning(disable : 4996)
#endif
//----
/*testtest
PFNGLGENBUFFERSARBPROC glGenBuffersARB;		// VBO 名前生成
PFNGLBINDBUFFERARBPROC glBindBufferARB;		// VBO 結びつけ
PFNGLBUFFERDATAARBPROC glBufferDataARB;		// VBO データロード
PFNGLDELETEBUFFERSARBPROC glDeleteBuffersARB;	// VBO 削除
*/
/*=========================================================================
【このソース内でのみ有効なグローバル変数】
=========================================================================*/
