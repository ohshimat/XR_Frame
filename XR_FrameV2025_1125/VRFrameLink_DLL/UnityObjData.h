#ifndef __UnityObjData_h__
#define __UnityObjData_h__
...
struct St_uo_face_data{
  ...
  uoThreedVector faceNormal;                      // 面法線

  vector <uoThreedVector>     vectorNormal;       // 頂点法線
  vector <St_uo_vf_detail_data> vf_data;            // vf詳細データ
   ...
   */
  //********************************************************************
  void St_uo_face_data::show(ostream &ost) const
  {
    ost << "======================================" << endl;
   ...
   */
  //********************************************************************
  void St_uo_face_data::clear(void)
  {
    groupNo = 0;
    groupName.clear();
    mtlnm.clear();
...
public:
  ...
  /*!
   *  @brief  面法線を取得取得します。
   *  @return  uoThreedVector * ... 3Dベクトルクラスオブジェクト
   *  @date  2008/12/1 ... 新規作成
   */
  //********************************************************************
  uoThreedVector *getFaceNormal(void);
   ...
   */
  //********************************************************************
  uoThreedVector *getVertexNormal(unsigned int val);

  //*******************************************************************
  /*!
   *  @brief  OBJ詳細データを取得します。
   *  @param  val ... [In] インデックス
   *  @return  uObjDetailData * ... OBJ詳細データクラスオブジェクト
   *  @date  2008/12/1 ... 新規作成
   */
  //********************************************************************
  uObjDetailData *getObjDetailData(unsigned int val);
   ...
   */
  //********************************************************************
  void setFaceNormal(const uoThreedVector *pval);
   ...
   */
  //********************************************************************
  void addVertexNormal(const uoThreedVector &pval);
   ...
   */
  //********************************************************************
  void addObjDetailData(const uObjDetailData &pval);
   ...
   */
  //********************************************************************
  void addIndex(const St_uo_vf_detail_data & pval);
   ...
   *  @return  St_uo_vf_detail_data ... 保持しているOBJインデックスデータ
   *  @date  2008/12/1 ... 新規作成
   */
  //********************************************************************
  St_uo_vf_detail_data getIndex(int index);

  //*******************************************************************
  /*!
   *  @brief  法線座標データを取得します。
   *  @param  index ... 取得データのインデックス
   *  @return  uoThreedVector ... 法線座標データ
   *  @date  2008/12/1 ... 新規作成
   */
  //********************************************************************
  uoThreedVector getVertexNormal(int index);
...
private:
  ...
  vector <uoThreedVector>     vertexNormal;       // 頂点法線
  vector <uObjDetailData>    objDetailData;      // OBJ詳細データ
  vector <St_uo_vf_detail_data> v_index;            // インデックスデータ
};
}
#endif
