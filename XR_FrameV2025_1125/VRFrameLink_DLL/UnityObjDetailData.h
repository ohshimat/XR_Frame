#ifndef __UnityObjDetailData_h__
#define __UnityObjDetailData_h__
...
public:
   ...
   */
  //********************************************************************
  void setVertexCoordinate(const uoThreedVector *pval);
   ...
   */
  //********************************************************************
  void setNormalCoordinate(const uoThreedVector *pval);

/*--------------*/
/* 非公開メンバ */
/*--------------*/
private:
  uoThreedVector vertexCoordinate;                // 頂点座標
  St_uo_TextureCoordinate st_texture;               // テクスチャ構造体
  uoThreedVector normalCoordinate;                // 法線座標
};
}
#endif
